        ...
        <tr class="hover:bg-gray-50 transition">
            ...
            <td class="px-6 py-4 text-center">
                <div class="flex gap-2 justify-center flex-wrap">
                    <button onclick="viewBillDetails(${index})" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-1 px-3 rounded transition text-sm">
                        👁️ View
                    </button>
                    <button onclick="editBillPayment(${index})" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-1 px-3 rounded transition text-sm">
                        ✏️ Edit
                    </button>
                    <button onclick="printBill(${index})" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-1 px-3 rounded transition text-sm">
                        🖨️ Print
                    </button>
                    <button onclick="deleteBill(${index})" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-1 px-3 rounded transition text-sm">
                        🗑️ Delete
                    </button>
                </div>
            </td>
