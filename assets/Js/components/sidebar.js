        ...
        <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col h-full shadow-xl lg:shadow-none">
            ...
            <div class="p-6 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    <div class="bg-[#16a34a] text-white h-10 w-10 flex items-center justify-center rounded-lg font-bold text-2xl shadow-md">सा</div>
                    <div>
                        <h1 class="text-xl font-bold text-gray-800 tracking-tight">sajha karobar</h1>
...
function initSidebar(activePage) {
    ...
    if (scrollableContent) {
        scrollableContent.classList.add('pb-20', 'lg:pb-8');
    }
